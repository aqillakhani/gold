...
print(f"Found {total_files} MP4 files to analyze...")
...
for clip_path in clip_files:
    ...
    if processed_count % 50 == 0:
        print(f"Processing {processed_count}/{total_files}...", flush=True)
    ...
    try:
        ...
        ffmpeg_cmd = [ffmpeg_exe, "-ss", str(midpoint), "-i", str(clip_path),
